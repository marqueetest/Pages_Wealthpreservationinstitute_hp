...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo ABSOLUTE_PATH;?>lb_styles.css" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				...
				<td colspan="3" align="center" style="padding:10px 27px; background-color:#142129;font-size:30px; font-weight:bold;  color:#FFFFFF ">
				    Pages Admin Login
				...
				<td colspan="3" valign="top" style="padding:27px; font-family:Arial; font-size:13px; color:#010000">
					...
					<table width="285" border="0" cellspacing="0" cellpadding="0" align="center">
					  ...
					  <tr>
						...
						<td width="85" align="left" >Username:
					  ...
					  <tr>
						...
						<td style="padding-top:2px; color:#020000;" align="left"><br />Can't remember your password? <a href="<?=ABSOLUTE_PATH?>admin/images/lb/forgot_password.php" style="color: #020000;float: right;margin-right: 15px;text-decoration: none;">Click here</a><br/>
			...
			<span id="login_processing"></span>
					  ...
					  <tr>
						...
						<td colspan="2" ><br /><span id="login_error" style="float:left; color:#990033"><?php echo $msg; ?>&nbsp;</span></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						...
						<td align="right">
							...
							<a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image49','','images/login_over.png',1)"><input type="image" src="images/login.png" name="Image4" width="72" height="26" border="0" id="Image49" onClick="javascript:login_user('<?php echo  ABSOLUTE_PATH;?>','')"/></a>
