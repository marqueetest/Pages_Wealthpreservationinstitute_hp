<?php
	...
	$mcImageManagerConfig['general.plugins'] = ""; // comma seperated
	...
	$mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'].'/images/rte';        //'../../../../../../files'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/images/rte';    //'../../../../../../files'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['thumbnail.prefix'] = "th_"; // 
