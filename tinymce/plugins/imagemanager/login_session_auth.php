<?php
    ...
    $_SESSION['user'] = 'Mahfooz';
    header("location: /test/image_manager/index.php?type=im&page=index.html");
	die;
...
<div class="container">
	<form action="login_session_auth.php" method="post">
		<input type="hiddn" name="return_url" value="<?php echo isset($_REQUEST['return_url']) ? htmlentities($_REQUEST['return_url']) : ""; ?>" />
