...
undefined) {
    ...
    q.prototype.createElement=function(a,
    b,
    c) {
    ...
    c) {
        ...
        a.className=b.join(" ").replace(/\s+/g,
        " ").replace(/^\s+|\s+$/,
        "")
    }
    function t(a,
    ...
    B.prototype.parse=function() {
        ...
        else if(-1!=this.a.indexOf("Opera"))a:if(a=z(E(this.a,
        /Presto\/([\d\w\.]+)/,
        1)),
        z(D(this)),
        null!==a.c||z(E(this.a,
...
z(E(this.a,
        ...
        else/OPR\/[\d.]+/.test(this.a)?a=F(this):/AppleWeb(K|k)it/.test(this.a)?a=F(this):-1!=this.a.indexOf("Gecko")? (a="Unknown",
        b=new y,
        z(D(this)),
        b=!1,
    ...
    ;
    function C(a) {
        var b=E(a.a, /(iPod|iPad|iPhone|Android|Windows Phone|BB\d {
            2
        }
        |BlackBerry)/,
        1);
    ...
    function D(a) {
        var b=E(a.a, /(OS X|Windows NT|Android) ([^;
        )]+)/, 2);
        if(b||(b=E(a.a, /Windows Phone( OS)? ([^;
        )]+)/, 2))||(b=E(a.a, /(iPhone)?OS ([\d_]+)/, 2)))return b;
        if(b=E(a.a, /(?: Linux|CrOS|CrKey) ([^;
        )]+)/, 1))for(var b=b.split(/\s/), c=0;
        c<b.length;
        c+=1)if(/^[\d\._]+$/.test(b[c]))return b[c];
        return(a=E(a.a, /(BB\d {
            2
        }
...
e?f="Unknown": "Silk"==e?f=E(a.a, /Silk\/([\d\._]+)/, 1): "Chrome"==e?f=E(a.a, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2): -1!=a.a.indexOf("Version/")?f=E(a.a, /Version\/([\d\.\w]+)/, 1): "AdobeAIR"==e?f=E(a.a, /AdobeAIR\/([\d\.]+)/, 1): "Opera"==e?f=E(a.a, /OPR\/([\d.]+)/, 1): "PhantomJS"==e&&(f=E(a.a, /PhantomJS\/([\d.]+)/, 1));
    ...
    b,
    c) {
        if(a.ha&&a.Q[b])if(c)a.Q[b](c.getName(), I(c));
        else a.Q[b]()
    }
    ;
    function ia() {
 ...
 function N(a) {
            ...
            var P= {
                sa: "serif", ra: "sans-serif", qa: "monospace"
            }
            ;
            ...
            e) {
                ...
                else for(a.S+=b.length, e&&(a.ba=e), e=0;
                e<b.length;
                e++) {
            ...
            d) {
                ...
                this.U--,
                a&&0==this.U?J(b):(this.R||this.T)&&ka(c,
                [],
                {},
                null,
                a))
            ...
            na.prototype.e=function() {
                ...
                for(var a=this.s.length, b=[], c=0;
                c<a;
                c++)b.push(this.s[c].replace(/ /g, "+"));
            ...
            pa.prototype.parse=function() {
                ...
                b++) {
                    ...
                    if(2<=c.length) {
                        ...
                        var g=c[1];
                        f=[];
                        if(g)for(var g=g.split(","), h=g.length, m=0;
                        m<h;
                        m++) {
                            var l;
                            l=g[m];
                            if(l.match(/^[\w-]+$/)) {
                                ...
                                if(null==l)p="";
                                    ...
                                    p=l[1];
                                    if(null==p||""==p)p="4";
                                    else var fa=ra[p], p=fa?fa: isNaN(p)?"4": p.substr(0, 1);
                                    l=l[2];
            ...
            V.prototype.aa=function(a) {
                for(var b=this.d, c=new na(this.f.api, u(b), this.f.text), d=this.f.families, e=d.length, f=0;
                f<e;
                f++) {
                    var g=d[f].split(":");
                ...
                c?w(this.d, this.J(c), function(a) {
                    if(a)b(!1);
                        ...
                        if(d.Typekit&&d.Typekit.config&&d.Typekit.config.fn) {
                            ...
                            for(var c=0;
                            c<a.length;
                            c+=2)for(var h=a[c], m=a[c+1], l=0;
                            l<m.length;
                            l++)e.p.push(new H(h, m[l]));
                            try {
                                d.Typekit.load( {
                                    events: !1, classes: !1
                                }
                ...
                if(d) {
                    ...
                    w(this.d, c.J(d, e), function(e) {
                        if(e)b(!1);
                            ...
                            if(f["__mti_fntLst"+d]&&(e=f["__mti_fntLst"+d]()))for(var h=0;
                            h<e.length;
                            h++)c.p.push(new H(e[h].fontfamily));
                            b(a.k.Y)
                        }
                    }
            ...
            Z.prototype.load=function(a) {
                ...
                b++) {
                    var g=e[b].split(":");
                    if(g[1])for(var h=g[1].split(","), m=0;
                    m<h.length;
                    m+=1)d.push(new H(g[0], h[m]));
            ...
            ;
            var $=new U(this);
            $.B.C.custom=function(a,
            b) {
                return new Z(b, a)
            }
            ;
            $.B.C.fontdeck=function(a,
            b) {
                return new W(b, a)
            }
            ;
            $.B.C.monotype=function(a,
            b) {
                return new Y(b, a)
            }
            ;
            $.B.C.typekit=function(a,
            b) {
                return new X(b, a)
            }
            ;
            $.B.C.google=function(a,
            b) {
                return new V(b, a)
            }
            ;
