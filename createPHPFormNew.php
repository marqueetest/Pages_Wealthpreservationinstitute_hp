...
<table width="625" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="30" colspan="4" align="left">Table Name: 
      <input type="text"  class="textbox" name="table_name" value="<?php isset($_GET['table']) ? $_GET['table'] : '';?>" /></td>
    </tr>
   <tr>
  ...
  <tr>
	...
	<?php
		if (isset($_GET['table']) ) {
			...
			$Conn_db = mysqli_connect($hostname, $username, $password) or die(mysqli_error());
			mysqli_select_db($database, $Conn_db);
